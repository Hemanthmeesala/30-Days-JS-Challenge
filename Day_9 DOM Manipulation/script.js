// Activity 01
//  - Task 01
document.getElementById("box1").textContent = "Task 01 changed";
...
div2.textContent = "Task 03 changed";
document.body.appendChild(div2);

//  - Task 04
let ul = document.getElementById("list1");
let new_li = document.createElement("li");
new_li.textContent = "Task 04 changed";
...
div_of_border.addEventListener(
	"mouseover",
	() => {
		div_of_border.style.borderColor = "red";
	},
	false,
);